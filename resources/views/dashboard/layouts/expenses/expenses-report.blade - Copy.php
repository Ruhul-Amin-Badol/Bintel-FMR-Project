                    ...
                    <table class="table datanew">
                        <thead>
                            <tr>
                                ...
                                <th class="text-dark"
                                    style="font-weight: 600; font-size:15px; width: 130px; ">Date
                                </th>
                                <th class="text-dark"
                                    style="font-weight: 600; font-size:15px; width: 160px; ">
                                    Employee ID</th>
                                <th class="text-dark"
                                    style="font-weight: 600; font-size:15px; width: 100px; ">Type
                                </th>
                                <th class="text-dark"
                                    style="font-weight: 600; font-size:15px; width: 100px; ">
                                    Total Cost</th>
                                <th class="text-dark"
                                    style="font-weight: 600; font-size:15px; width: 300px; ">
                                    Comments</th>
                                <th class="text-dark"
                                    style="font-weight: 600; font-size:15px; width: 150px; ">
                                    Created On</th>
                                <th class="text-dark"
                                    style="font-weight: 600; font-size:15px; width: 100px; ">
                                    Action</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($expenses as $expense)
                                @php
                                    if ($expense->type == 'TA') {
                                        $ta += $expense->total_cost;
                                    }
                                    if ($expense->type == 'DA') {
                                        $da += $expense->total_cost;
                                    }
                                    if ($expense->type == 'Convenience') {
                                        $ma += $expense->total_cost;
                                    }
                                    if ($expense->type == 'Rent') {
                                        $rent += $expense->total_cost;
                                    }
                                    if ($expense->type == 'Others') {
                                        $others += $expense->total_cost;
                                    }

                                @endphp
                                <tr>
                                    <td>{{ date('d-m-y', strtotime($expense->expenses_date)) }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a class="me-3 delete-btn"
                                            href="{{ route('expenses.delete', encrypt($expense->id)) }}">
                                ...
                                @php
                                    $totalCost += $expense->total_cost; // Add cost to total cost
                                @endphp
                            @endforeach
                        </tbody>
                        <tfoot>
                            ...
                            <tr>
                                <td class="text-dark"
                                    style="font-weight: 600; text-align:center; font-size:15px; ">
                                    Total TA- {{ $ta }}৳</td>
                                <td class="text-dark"
                                    style="font-weight: 600; text-align:center; font-size:15px; ">
                                    Total DA- {{ $da }}৳</td>
                                ...
                                <td class="text-dark"
                                    style="font-weight: 600; text-align:center; font-size:15px;">
                                    Total Others- {{ $others }}৳</td>
                                <td class="text-dark"
                                    style="font-weight: 600; text-align:center; font-size:16px; ">
                                    Grand Total</td>
                                <td class="text-dark"
                                    style="font-weight: 600; text-align:center; font-size:16px; ">
                                    {{ $totalCost }}৳</td>
