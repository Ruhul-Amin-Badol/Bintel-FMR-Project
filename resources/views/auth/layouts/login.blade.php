            ...
            <div class="forny-form">
                <div class="mb-8 text-center forny-logo">
                    <img style="max-height:50px"
                        src="{{asset("resources/assets/img/logo_sms.gif")}}">
                </div>
                <div class="text-center">
                    ...
                    @if ($errors->any())
                        <h4 class="alert alert-danger" id="alert">{{ $errors->first() }}</h4>
                    ...
                    <div class="row mt-6 mb-6">
                        <div class="col-6 d-flex align-items-center">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="cb1" name="remember_token">
